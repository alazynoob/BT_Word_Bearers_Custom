...
class O_BTWord_Bearers_Mk_2Initiate_3Umbra_Bolter_40k_01 : O_BTWord_Bearers_Mk_2Initiate_3Volkite_Culverin_40k_01 {
    author = "[SB] Balderic Caeledis";
    scope = 2;
    scopeCurator = 2;
    displayName = "Mk.2 Initiate 3 Umbra";
    side = 0;
    faction = "O__BT_WordBearers_40k";
    editorSubcategory = "BT_WordBearers_MkII_Initiate_3";
    identityTypes[] = {"TIOW_Marine_Head","LanguageENGVR_F","NoGlasses"};
...
class O_BTWord_Bearers_Mk_2Initiate_3Autocannon_01 : O_BTWord_Bearers_Mk_2Initiate_3Umbra_Bolter_40k_01 {
    author = "[SB] Balderic Caeledis";
    scope = 2;
    scopeCurator = 2;
    displayName = "MK.2 Initiate 3 Autocannon";
    side = 0;
    faction = "O__BT_WordBearers_40k";
    editorSubcategory = "BT_WordBearers_MkII_Initiate_3";
    identityTypes[] = {"TIOW_Marine_Head","LanguageENGVR_F","NoGlasses"};
